...
class DeviceFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        if (
            ...
            $rules = array_merge($rules, ['id' => ['required','string','exists:'.config('wk-core.table.device.devices').',id']]);
        } elseif ($request->isMethod('post')) {
            $rules = array_merge($rules, ['id' => ['nullable','string','exists:'.config('wk-core.table.device.devices').',id']]);
        }

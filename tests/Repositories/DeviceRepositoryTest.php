...
use WalkerChiu\Device\Models\Repositories\DeviceRepository;
...
class DeviceRepositoryTest extends \Orchestra\Testbench\TestCase
{
     ...
     *     WalkerChiu\Device\Models\Repositories\DeviceRepository
     * 
     * @return void
     */
    ...
    public function testEnableAndDisable()
    {
        ...
        // Give
        $db_morph_1 = factory(Device::class)->create(['is_enabled' => 1]);
        $db_morph_2 = factory(Device::class)->create();
        $db_morph_3 = factory(Device::class)->create();
        $db_morph_4 = factory(Device::class)->create();
    ...
    public function testFormTrait()
    {
        ...
        // Name
            ...
            $db_lang_2 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_2->id, 'morph_type' => Device::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
            // When
        ...
        // Serial, Identifier
            // Give
            $db_morph_3 = factory(Device::class)->create(['serial' => '123', 'identifier' => 'A123']);
            $db_morph_4 = factory(Device::class)->create(['serial' => '124', 'identifier' => 'A124']);
            $db_morph_5 = factory(Device::class)->create(['serial' => '125', 'identifier' => 'A125', 'is_enabled' => 0]);

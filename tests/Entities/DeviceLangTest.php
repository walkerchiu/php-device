...
class DeviceLangTest extends \Orchestra\Testbench\TestCase
{
    ...
    protected function getPackageProviders($app)
    {
        return [\WalkerChiu\Core\CoreServiceProvider::class,
                \WalkerChiu\Device\DeviceServiceProvider::class];
    }
     ...
     *     WalkerChiu\Device\Models\Entities\DeviceLang
     *
     * @return void
     */
    public function testDeviceLang()
    {
        ...
        Config::set('wk-device.onoff.core-lang_core', 0);
        Config::set('wk-core.lang_log', 1);
        Config::set('wk-device.lang_log', 1);
        Config::set('wk-core.soft_delete', 1);
        Config::set('wk-device.soft_delete', 1);

        // Give
        $db_morph_1 = factory(Device::class)->create();
        $db_morph_2 = factory(Device::class)->create();
        $db_lang_1 = factory(DeviceLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => Device::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $db_lang_2 = factory(DeviceLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => Device::class, 'code' => 'en_us', 'key' => 'description']);
        $db_lang_3 = factory(DeviceLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => Device::class, 'code' => 'zh_tw', 'key' => 'description']);
        $db_lang_4 = factory(DeviceLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => Device::class, 'code' => 'en_us', 'key' => 'name']);
        $db_lang_5 = factory(DeviceLang::class)->create(['morph_id' => $db_morph_2->id, 'morph_type' => Device::class, 'code' => 'en_us', 'key' => 'name']);
        $db_lang_6 = factory(DeviceLang::class)->create(['morph_id' => $db_morph_2->id, 'morph_type' => Device::class, 'code' => 'zh_tw', 'key' => 'description']);
        ...
        // Get record's morph
            // When
            $record = DeviceLang::find($db_lang_1->id);
            // Then
    ...
    public function testDevice()
    {
        ...
        // Get lang of record
            // When
            $record_1 = Device::find($db_morph_1->id);
            $lang_1   = DeviceLang::find($db_lang_1->id);
            $lang_4   = DeviceLang::find($db_lang_4->id);
            // Then
        ...
        // Get lang's histories of record
            ...
            $record_2 = Device::find($db_morph_2->id);
